...
<head>
  ...
  <meta charset="utf-8"/>
  <title>
    @php $title = DB::table('settings')->first(); @endphp
          ...
          <div class="login-signin text-white">
            ...
            <form method="POST" action="{{ route('password.update') }}">
              ...
              <div class="form-group">
                <input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8 @error('email') is-invalid @enderror" id="email" type="email" value="{{ $email ?? old('email') }}" placeholder="Email" name="email" autocomplete="off" autofocus/>
              </div>
