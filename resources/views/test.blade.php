            ...
            <table class="table table-bordered" width="100%">
              <thead class="thead-dark">
                <tr>
                  ...
                  <th class="align-middle text-nowrap text-right"><a href="#"><i class="fa fa-check-square text-white"></i></th>
                  </tr>
                </thead>
                <tbody>
          ...
          <div class="container-fluid">
            <div class="table-responsive">
              <table class="table table-bordered" width="100%">
                <thead class="thead-dark">
                  <tr>
                    <th class="align-middle text-nowrap" colspan="3"> BIGO STLH </th>
                    <th class="align-middle text-nowrap text-right"><a href="{{ URL::Current() }}/get-event-special-talent-live-house"><button type="button" class="btn btn-primary btn-sm"><i class="fa fa-refresh text-white"></button></i></th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-nowrap text-center" width="200px"> {{ \Carbon\Carbon::parse($data_event_special_talent_live_house['5'])->format('H:i') }} </td>
