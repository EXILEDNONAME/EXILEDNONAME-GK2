...
@include('pages.backend.__templates.datatable.extension.javascript.table-reset')
@include('pages.backend.__templates.datatable.extension.javascript.start-optimizing')
</script>
@endpush
