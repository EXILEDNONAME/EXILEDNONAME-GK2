...
@push('title', 'PK Weekend')

@push('alert')
<div class="alert alert-primary" role="alert">
  Master Data : <a href="https://docs.google.com/spreadsheets/d/1a5np5Cs8V-wmPgJEw2yPCIAGBnHbCts1HjtcOEB3uvQ/edit#gid=406546051" target="_blank" class="alert-link"> Source </a><br>
  Get New Data From : <a href="https://docs.google.com/spreadsheets/d/1a5np5Cs8V-wmPgJEw2yPCIAGBnHbCts1HjtcOEB3uvQ/export?format=csv&gid=406546051" target="_blank" class="alert-link"> Source </a><br>
</div>
<hr>
@endpush
