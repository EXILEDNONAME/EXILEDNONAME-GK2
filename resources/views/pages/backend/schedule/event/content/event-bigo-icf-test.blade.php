          ...
          <table class="table table-bordered fixed" width="100%">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="align-middle text-nowrap text-center table-white" width="50px"> {{ $data->col_5 }} </td>
                <td class="align-middle text-nowrap text-center table-white" width="50px"> {{ $data->col_1 }} </td>
                <td class="align-middle text-nowrap text-center table-white" width="200px">
                  @php $username = \DB::table('family_members')->where('id_bigo', $data->col_1)->first(); @endphp
