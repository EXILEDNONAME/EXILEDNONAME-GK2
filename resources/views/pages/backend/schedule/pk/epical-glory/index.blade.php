...
@section('title', 'Schedule PK Epical Glory')
        ...
        <div class="table-responsive">
          <table class="table table-bordered" width="100%">
            <thead class="thead-dark">
              <tr>
                ...
                <th class="align-middle text-nowrap text-right" colspan="3">
                  <a href="{{ URL::Current() }}/../get-pk-epical-glory">
            ...
            <tbody>
              ...
              <tr>
                @if(str_contains($data_pk_epical_glory['2'], 'ᴳᴷ🔥') OR str_contains($data_pk_epical_glory['14'], 'ᴳᴷ🔥'))
                <td class="align-middle text-nowrap text-center table-white" width="50px"> PK PARTY {{ env('SHEET_PK_EPICAL_GLORY')}} </td>
                ...
                <td class="align-middle text-nowrap text-center table-white"> {{ $data_pk_epical_glory['14'] . ' (' . $data_pk_epical_glory['16'] . ')' }} </td>
                @endif
              </tr>
              @endforeach
            </tbody>
