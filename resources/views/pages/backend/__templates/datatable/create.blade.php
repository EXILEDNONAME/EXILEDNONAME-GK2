    ...
    <div class="card card-custom gutter-b card-sticky" data-card="true" id="exilednoname_card_sticky">
      <div class="card-header">
        ...
        <div class="card-toolbar">
          <a href="{{ url_previous() }}" class="btn btn-sm btn-outline-primary font-weight-bolder mr-1">
      ...
      <div class="card-body">
        ...
        <form method="POST" id="exilednoname-form" action="{{ URL::current() }}/../" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
          ...
          @include('pages.backend.__templates.datatable.extension.form.datetime')
          @include('pages.backend.__templates.datatable.extension.form.status')
          @include($path . 'form', ['formMode' => 'create'])
          @include('pages.backend.__templates.datatable.extension.form.active')
        </form>
