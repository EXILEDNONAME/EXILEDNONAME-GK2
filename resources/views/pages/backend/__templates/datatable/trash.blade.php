    ...
    <div class="card card-custom gutter-b card-sticky" data-card="true" id="kt_page_sticky_card">
      <div class="card-header">
        ...
        <div class="card-toolbar">
          <a href="{{ url_previous() }}" class="btn btn-icon btn-xs btn-hover-light-primary mr-1" data-toggle="tooltip" data-placement="top" title="" data-original-title="{{ __('default.label.back') }}"><i class="fas fa-arrow-left"></i></a>
...
@include('pages.backend.__templates.datatable.extension.javascript.restore')
@include('pages.backend.__templates.datatable.extension.javascript.delete-permanent')
@include('pages.backend.__templates.datatable.extension.javascript.selected-restore')
@include('pages.backend.__templates.datatable.extension.javascript.selected-delete-permanent')
</script>
@endpush
