...
<div class="form-group row">
  ...
  <div class="col-lg-9">
    {{ Html::select('verify', ['1' => __('default.label.yes'), '0' => __('default.label.no')], (isset($data->verify) ? $data->verify : '1'))->placeholder('- Select Status Verify -')->class($errors->has('verify') ? 'form-control is-invalid' : 'form-control')->required() }}
...
<div class="form-group row">
  ...
  <div class="col-lg-9">
    {{ Html::select('official', ['1' => __('default.label.yes'), '0' => __('default.label.no')], (isset($data->official) ? $data->official : NULL))->placeholder('- Select Status Official Host -')->class($errors->has('official') ? 'form-control is-invalid' : 'form-control')->required() }}
