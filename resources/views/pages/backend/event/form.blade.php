...
<div class="form-group row">
  ...
  <div class="col-lg-9">
    {{ Html::select('event', ['BIGO CONTENT CHALLENGE' => 'BIGO CONTENT CHALLENGE', 'ICF' => 'ICF'], (isset($data->event) ? $data->event : NULL))->class($errors->has('active') ? 'form-control is-invalid' : 'form-control')->placeholder('- Select Event -')->required() }}
