...
class CrudMigrationCommand extends GeneratorCommand
{
  ...
  */
  ...
  {
    return config('crudgenerator.custom_template') ? './resources/__stubs/migration.stub' : './resources/__stubs/migration.stub';
  }
  ...
  */
  protected function getPath($name)
  {
    ...
    return database_path('/migrations/') . $datePrefix . '_create_main_' . $name . '_table.php';
  }
