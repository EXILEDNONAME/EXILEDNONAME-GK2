...
class CrudCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $modelNamespace = ($this->option('model-namespace')) ? trim($this->option('model-namespace')) . '\\' : 'App\\Models\\Backend\\Main\\';
    ...
    protected function addRoutes()
    {
      $name = $this->argument('name');
      $modelName = Str::singular($name);
        return ["Route::resource('/dashboard/" . $this->routeName . "', 'App\Http\Controllers\Backend\Main\\" . $modelName . "Controller');"];
    }
