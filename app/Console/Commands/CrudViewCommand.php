...
class CrudViewCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $this->viewDirectoryPath = config('crudgenerator.custom_template') ? './resources/__stubs/views/' . $formHelper . '/' : './resources/__stubs/views/' . $formHelper . '/';
