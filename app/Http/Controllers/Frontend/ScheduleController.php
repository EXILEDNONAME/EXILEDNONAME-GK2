...
class ScheduleController extends Controller {
  ...
  public function index() {
    ...
    // E-COMMERCE
    if ( $xlsx = SimpleXLSX::parse($file_event_content_e_commerce) ) {
    ...
    return view('test', compact('data_event_content_challenge', 'date_event_content_challenge', 'data_event_content_festival', 'date_event_content_festival', 'data_event_e_commerce', 'date_event_e_commerce'));
