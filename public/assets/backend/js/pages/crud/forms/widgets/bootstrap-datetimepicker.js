...
var KTBootstrapDatetimepicker = function () {
  ...
  var baseDemos = function () {
    ...
    $('#ex_datetimepicker_date_start').datetimepicker({
      locale: 'id', format:'YYYY-MM-DD HH:mm',
    });

    $('#ex_datetimepicker_date_end').datetimepicker({
      locale: 'id', format:'YYYY-MM-DD HH:mm',
    });

    $('#ex_datetimepicker_birthdate').datetimepicker({
